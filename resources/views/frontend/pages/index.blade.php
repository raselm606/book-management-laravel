        ...
        <div id="carouselExampleIndicators" class="carousel slide main-slider" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="{{asset('front_assets/images/sliders/slider1.png')}}" class="d-block w-100">
                ...
                <div class="carousel-item">
                    <img src="{{asset('front_assets/images/sliders/slider2.png')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h3>Welcome to your Book Sharing Platform</h3>
                        <p>
                ...
                <div class="carousel-item">
                    <img src="{{asset('front_assets/images/sliders/slider3.jpg')}}" class="d-block w-100" alt="...">
                    <div class="carousel-caption d-none d-md-block">
                        <h3>Welcome to your Book Sharing Platform</h3>
                        <p>
                            <a href="" class="btn btn-primary slider-link">
        ...
        <div class="top-body pt-4 pb-4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card card-body single-top-link"  onclick="location.href='signup'">
                            <h4>Create New</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="single-book">
                                    <img src="{{('front_assets/images/books/book.jpg')}}" alt="">
                                    <div class="book-short-info">
                                        <h5>Java Programming</h5>
                                        <p>
                                            <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
                                        </p>
                                        <a href="{{route('book-single')}}" class="btn btn-outline-primary"><i class="fa fa-eye"></i> View</a>
                            ...
                            <div class="col-md-4">
                                <div class="single-book">
                                    <img src="{{('front_assets/images/books/book2.jpg')}}" alt="">
                                    <div class="book-short-info">
                                        <h5>C Programming</h5>
                                        <p>
                                            <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
                            ...
                            <div class="col-md-4">
                                <div class="single-book">
                                    <img src="{{('front_assets/images/books/book1.jpg')}}" alt="">
                                    <div class="book-short-info">
                                        <h5>C++ Programming</h5>
                                        <p>
                                            <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
                            ...
                            <div class="col-md-4">
                                <div class="single-book">
                                    <img src="{{('front_assets/images/books/book3.jpg')}}" alt="">
                                    <div class="book-short-info">
                                        <h5>Java Programming</h5>
                                        <p>
                                            <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
                            ...
                            <div class="col-md-4">
                                <div class="single-book">
                                    <img src="{{('front_assets/images/books/book4.jpg')}}" alt="">
                                    <div class="book-short-info">
                                        <h5>Java Programming</h5>
                                        <p>
                                            <a href="" class=""><i class="fa fa-upload"></i> Polash Rana</a>
